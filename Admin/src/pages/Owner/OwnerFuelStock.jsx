...
const OwnerFuelStock = () => {
  ...
  if (loading) return (
    <div className="flex justify-center items-center p-8">
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-600">Loading fuel stock...</p>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Fuel Stock Overview</h1>
        <p className="text-gray-600">Monitor current fuel stock levels across your stations</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Benzene</h2>
              <p className="text-gray-600">Current available stock</p>
            </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600">Liters</p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 hover:shadow-md transition-shadow duration-200">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Diesel</h2>
              <p className="text-gray-600">Current available stock</p>
            </div>
      ...
      <div className="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-4xl mx-auto">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Stock Monitoring</h3>
