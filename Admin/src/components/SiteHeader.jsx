...
export function SiteHeader() {
  return (
    <header className="flex h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height) bg-background/80 backdrop-blur-xl sticky top-0 z-50">
            ...
            <div className="ml-auto flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="group relative cursor-pointer">
                  ...
                  <div className="absolute -bottom-1 -right-1 h-2.5 w-2.5 rounded-full bg-brand-500 border-2 border-background shadow-sm"></div>
                </div>
              </div>
            </div>
        </div>
